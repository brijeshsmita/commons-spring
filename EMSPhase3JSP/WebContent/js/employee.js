function validateForm()
{
	...
	var x=document.forms["frmAddEmployee"]["empName"].value;
	...
	var x=document.forms["frmAddEmployee"]["emailId"].value;
	var atpos=x.indexOf("@");
	...
	var x=document.forms["frmAddEmployee"]["phoneNo"].value;
	...
	var x=document.forms["frmAddEmployee"]["dob"].value;
...
//parsing the formatted date into Date 	
	...
	if((currentyear-n)<21||(currentyear-n)>60)
	{
		...
		var x=document.forms["frmAddEmployee"]["doj"].value;
		var d = new Date(x);
		var n = d.getFullYear();
		//alert("Year"+n);
		var y=new Date();
